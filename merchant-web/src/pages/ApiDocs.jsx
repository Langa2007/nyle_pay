...
const endpoints = [
  {
    ...
    description: 'Sends a Resend email confirmation link for NylePay Business access.',
    body: { fullName: 'Jane Wanjiru', email: 'payments@example.com' },
  },
  {
    group: 'Authentication',
    method: 'GET',
    path: '/api/auth/business-access/confirm?token={token}',
    auth: 'Public',
    title: 'Confirm business email',
    description: 'Verifies the email confirmation token and returns a JWT for the Business dashboard.',
  },
  {
