...
const ENDPOINTS = [
  ...
  { id: 'quote-paypal-wallet', label: 'Quote PayPal to Wallet', method: 'POST', path: '/api/routes/quote', auth: 'secret', body: { sourceRail: 'PAYPAL', sourceAsset: 'USD', destinationRail: 'NYLEPAY_WALLET', destinationAsset: 'KSH', amount: 20, destination: { returnUrl: 'https://example.com/paypal/return', cancelUrl: 'https://example.com/paypal/cancel' }, idempotencyKey: 'TEST-PAYPAL-001' }, desc: 'Quote PayPal checkout intake that routes captured value into NylePay.' },
  ...
  { id: 'execute-paypal-wallet', label: 'Execute PayPal Intake', method: 'POST', path: '/api/routes/execute', auth: 'secret', body: { sourceRail: 'PAYPAL', sourceAsset: 'USD', destinationRail: 'NYLEPAY_WALLET', destinationAsset: 'KSH', amount: 20, destination: { returnUrl: 'https://example.com/paypal/return', cancelUrl: 'https://example.com/paypal/cancel' }, idempotencyKey: 'TEST-PAYPAL-EXEC-001' }, desc: 'Create a sandbox PayPal order and continue the NylePay route after capture confirmation.' },
